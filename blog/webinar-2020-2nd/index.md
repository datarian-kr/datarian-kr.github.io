...
<span style="color:white">.</span>  
참가자분께서 사전 질문으로 보내주신 사연이에요. "안녕하세요, 입사한지 100일하고 20일이 막 지난 삐약이 데이터 분석가입니다. 계약직으로 회사에 입사했더니 데이터 추출만 시키네요. 1년 뒤면 쿼리 머신이 되어버릴 듯 합니다. 그런데 회사 입장에서 가성비 측면으로 생각했을 때는 앞으로 1년간 업무에서 큰 변화가 없을 것 같아요. 이런 상황에서 여러분들이라면 어떻게 하실 것 같나요?"  
