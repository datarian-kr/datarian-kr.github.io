# 직방, 다방, 네이버 부동산, 집토스 뭐가 다를까? (부제: 프롭테크 산업이란?)
...
![img/zigbang_main_page.png](img/zigbang_main_page.png)

*직방:* *아파트 / 빌라 / 원룸 / 오피스텔로 탭이 분리되어있다.*

![img/zigbang_filter.png](img/zigbang_filter.png)

*직방: 간단한 필터만 제공된다.*

![img/zigbang_apt_reviews.png](img/zigbang_apt_reviews.png)
...
![img/dabang_filter_1.png](img/dabang_filter_1.png)

*다방: 상세한 필터1*

![img/dabang_filter_2.png](img/dabang_filter_2.png)

*다방: 상세한 필터2*

![img/dabang_infographic.png](img/dabang_infographic.png)
...
![img/naver_fillter_2.png](img/naver_fillter_2.png)

*네이버 부동산: 방향*

![img/naver_filter_3.png](img/naver_filter_3.png)

*네이버 부동산: 보안 및 내부시설*

![img/naver_filter_4.png](img/naver_filter_4.png)
...
![img/zigbang_open_graph.png](img/zigbang_open_graph.png)

*직방: 카톡 공유시 화면*

![img/naver_open_graph.png](img/naver_open_graph.png)
...
![img/ziptoss_review_detail.png](img/ziptoss_review_detail.png)
...
![img/ziptoss_manager_chat2.jpeg](img/ziptoss_manager_chat2.jpeg)
...
![img/ziptoss_filter.png](img/ziptoss_filter.png)

*집토스: 필터*

![img/ziptoss_infographic.png](img/ziptoss_infographic.png)
...
*직방: 아파트 상세정보 페이지에서 가장 강조되어 있는 "3D단지투어" 버튼*
...
집토스 소개 기사 [https://platum.kr/archives/91283](https://platum.kr/archives/91283)
