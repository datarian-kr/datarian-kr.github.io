...
정확한 기간은 모르지만, 일 년이 넘는 시간동안 결제 데이터를 보다보니 한 가지 일관된 패턴을 발견했습니다. <br>
...
인프런 강의의 커리큘럼을 보시면 알 수 있듯, 각 강의는 동일한 주제의 영상을 하나의 섹션으로 묶어 제공하고 있습니다. 어떤 영상을 가장 많이 반복 재생하고, 반복 재생을 많이 하는 영상은 어떤 섹션에 가장 많을까요?
